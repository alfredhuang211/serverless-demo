...
为了便于后续的操作，我们在这里也直接提供我们导出的模型文件供后续操作，可以点击这里的[导出模型文件链接](https://main.qcloudimg.com/raw/c184a8b6e802192e4ff71ecb4cb07ec8.zip)来下载。

## 测试文件准备

测试文件我们可以从 MNIST 的测试集中随意抽取若干，用于验证我们最终推理 API 的工作状态。同样，我们也在这里准备了若干图片用于最终验证，可以通过这里的[测试图片文件链接](https://main.qcloudimg.com/raw/3353ca26b71061c7b3f3c57bc8039832.zip)来下载；或者记录以下连接，用于直接测试在线图片的推理情况。
